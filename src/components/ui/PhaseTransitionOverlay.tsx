...
const PHASE_DETAILS: Record<GamePhase, { title: string; subtitle: string; icon: any; color: string }> = {
  LOBBY: {
    title: 'LOBBY OPEN',
  ...
  BUILDING: {
    ...
    subtitle: '15-Minute Architecture Formulations Started',
    icon: Zap,
  ...
  PITCHING: {
    ...
    subtitle: '60-Second Solution Presentations on Stage',
    icon: Radio,
...
export function PhaseTransitionOverlay() {
  ...
  const info = PHASE_DETAILS[activeBanner.phase] || PHASE_DETAILS.LOBBY
