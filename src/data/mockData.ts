...
export const TOURNAMENT_ROUNDS = [
  {
    ...
    subtitle: 'Open Qualifier · Zero Elimination (Unscored Checkpoint)',
    elimination: 'Zero Elimination — All 16 registered squads automatically advance to Round 2!',
    rule: 'Teams select their problem statement, draft 3 surprise tech cards, and pitch their understanding of the problem root causes and limitations of existing market alternatives.',
    focus: 'Problem Root Causes, User Pain Points, Existing Alternative Critique, Initial Tech Alignment',
    marks: 'Qualifying Checkpoint',
    capacity: 'Open Entry (16 Teams)',
    badge: 'Round 1 / Zero Elimination (All Advance)',
  },
  {
    round: 2,
    name: 'Round 2: 1v1 Head-to-Head Problem Statement Showdown',
    subtitle: '100 Pts 1v1 Duel · 8 Problem Champions Advance to Grand Finals',
    elimination: 'Direct 1v1 Battle between squads on the same problem track. The winner of each problem duel advances as Problem Champion (8 Finalists total). Defeated squads are eliminated.',
    rule: 'Teams present their enhanced architecture and 3-card tech integration directly against the rival squad sharing their problem statement. The higher-scoring squad per problem track advances to Round 3.',
    focus: 'Enhanced Solution Architecture, 3-Card Tech Integration, Feasibility & Scalability, Novel Ideation',
    marks: '100 Pts 1v1 Duel',
    capacity: '16 Teams (8 Problem Tracks × 2 Teams)',
    badge: 'Round 2 / 8 Problem Champions Qualify (100 Pts)',
  },
  {
    round: 3,
    name: 'Round 3: Grand Finals & Stage Defense (8 Problem Champions)',
    subtitle: '8 Problem Champions · Top 4 Crowned on Prize Podium',
    elimination: 'Top 4 Awarded: 🥇 1st Place Champion (1), 🥈 2nd Place Runner-Up (1), 🥉 Dual 3rd Place Bronze Winners (2)',
    rule: 'The 8 Problem Champions deliver their master blueprints and defend live on stage against aggressive judge cross-examination.',
    focus: 'Master System Pitch, Live Defense & Q&A, Business Viability, Edge-to-Cloud Flow',
    marks: 'Championship Podium Ranking',
    capacity: '8 Problem Champions',
